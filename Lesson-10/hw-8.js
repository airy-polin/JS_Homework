...
console.log(deepCompare(initialObj, clonedObj)); // 2 разные ссылки на объект (объект и его клон)
console.log(deepCompare(initialObj, newObj)); // 2 разных объекта
console.log(deepCompare(clonedObj, newObj)); // 2 разных объекта
console.log(deepCompare(copiedObj, newObj)); // 2 разных объекта
console.log(deepCompare(initialObj, copiedObj)); // одна и та же ссылка на объект (объект и его копия)

console.log(deepCompare(obj1, obj2)); // 2 разных объекта
//------------------------------------------------------------------------------------------------------------------------------------------------